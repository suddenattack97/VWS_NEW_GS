		...
		if(arr_area_code){
			$.each(arr_area_code, function(index, item){
				...
				if(!document.getElementById("snow_"+item+"_marker")){
					...
					marker_content.innerHTML+="<div id='snow_"+item+"_marker' style='margin-top:-38px; margin-left: -10px;' class=''>\n\
					<img style='cursor:"+(map_control_type == 1 ? 'not-allowed' : 'pointer')+"; -webkit-user-drag: none;' src='img/icon_s_04.png'/></div>";
				}
