...
exports['default'] = sweetAlert = swal = function () {
  ...
  sweetOption = params; // CC
};

sweetAlert.getState = swal.getState = function () { // CC
	if( $( _modulesHandleSwalDom.getModal() ).css("display") != "none" ){
		return true;
	}else{
		return false;
	}
...
sweetAlert.getOutsideClick = swal.getOutsideClick = function () { // CC
	return sweetOption.allowOutsideClick;
};
 ...
 */
sweetAlert.close = swal.close = function () { // AA
  if( $("#popup_layout").length == 0 || $("#popup_layout").css("display") == "none" ){
...
//  (0, _modulesHandleDom.addClass)($errorIcon, 'show'); // BB

  var $errorContainer = modal.querySelector('.sa-error-container');
//  (0, _modulesHandleDom.addClass)($errorContainer, 'show'); // BB

//  $errorContainer.querySelector('p').innerHTML = errorMessage; // BB
  modal.querySelector('#notice').innerHTML = '<div class="notice_icon">!</div><div class="notice_text">'+errorMessage+'</div>'; // BB
...
var handleButton = function handleButton(event, params, modal) {
  ...
  switch (e.type) {
    ...
    case 'click':
      ...
      if (!clickedOnModal && !clickedOnModalChild && !params.allowOutsideClick) { // AA
        break;
      }  	
 ...
 */
var openModal = function openModal(callback) { // AA
