...
require_once "../_info/_wa_temprpt.php";
...
<div id="right">
	...
	<div id="content">
		...
		<form id="wa_frm" action="wa_temprpt.php" method="get">

		<div class="main_contitle">
			<img src="../images/title_09_05.png" alt="수온 보고서">
...
$(document).ready(function(){
	...
	function graph_on(){
		...
		$.ajax({
		    ...
		    data: { "mode" : "wa_temprpt", "area_code" : $("#area_code").val(), "sdate" : "<?=$sdate?>" },
	        cache: false,
	        dataType: "json",
