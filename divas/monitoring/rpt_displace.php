...
require_once "../_info/_rpt_disp.php";
...
<div id="right">
	...
	<div id="content">
		...
		<form id="form_search" action="rpt_displace.php" method="get">
			
		<div class="main_contitle">
			<img src="../images/title_05_031.png" alt="변위 보고서">
...
$(document).ready(function(){
	...
	function graph_on(){
		...
		$.ajax({
		    ...
		    data: { "mode" : "disp", "area_code" : $("#area_code").val(), "type" : "<?=$type?>", "sdate" : "<?=$sdate?>" },
	        cache: false,
	        dataType: "json",
	...
	$("#graph").attr("height", tmp_height*0.84);
