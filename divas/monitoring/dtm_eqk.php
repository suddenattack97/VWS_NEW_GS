...
require_once "../_info/_dtm_rain.php";
...
<div id="right">
	...
	<div id="content">
		...
		<div class="main_contitle">
			<img src="../images/title_04_011.png" alt="지진 자료">
...
<div id="popup_layout" class="popup_layout_e">
	...
	<div class="popup_con_2">
		<form id="dtm_frm" name="dtm_frm" method="post">
            ...
            <table class="tb_data_p2 bL_1gry">
              ...
              <tr>
                <td><input type="text" id="min_1" name="min[]"></td>
                <td><input type="text" id="min_2" name="min[]"></td>
                <td><input type="text" id="min_3" name="min[]"></td>
                <td><input type="text" id="min_4" name="min[]"></td>
                <td><input type="text" id="min_5" name="min[]"></td>
                <td><input type="text" id="min_6" name="min[]"></td>
              </tr>
            </table>
...
$(document).ready(function(){
	...
	$("#view_table #data").click(function(){
		...
		$.ajax({
		    ...
		    data: { "mode" : "rain", "area_code" : area_code, "sdate" : "<?=$sdate?>", "hour" : hour },
	        cache: false,
	        dataType: "json",
