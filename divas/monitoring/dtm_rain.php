...
<div id="right">
	...
	<div id="content">
		...
		<div class="tit"><img src="../images/board_icon_aws.png"> <span>강우자료</span></div>
...
<div id="popup_layout" class="popup_layout_e">
	<div class="popup_top"><span id="rtu_name"></span>강우 자료 수정
...
$(document).ready(function(){
	...
	$("#view_table #data").click(function(){
		...
		$.ajax({
		    ...
		    data: { "mode" : "rain", "area_code" : area_code, "sdate" : "<?=$sdate?>", "hour" : hour, "OTT" : "<?=$ott?>"},
	        cache: false,
	        dataType: "json",
