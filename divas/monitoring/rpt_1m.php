...
require_once "../_info/_rpt_1m.php";
...
<div id="right">
	...
	<div id="content">
		...
		<form id="form_search" action="rpt_1m.php" method="get">
		
		<div class="main_contitle">
			<img src="../images/title_10_01.png" alt="1분 자료">
		...
		<ul class="ulwrap_nh">
			<li class="tb_sms_gry">
				<span class="sel_left80_np"> 
					...
					&nbsp;&nbsp;
					<img src="../images/icon_cal.png" alt="달력보기" id="btn_img1">
					&nbsp;
					<select id="stime" name="stime">
						<? 
						for($i=0; $i <= 23; $i++){ 
						?>
							<option value="<?=$i?>" <?if($i == $stime){echo "selected";}?>><?=$i?></option>
						<? 
						}
						?>	
					</select> &nbsp;시
					...
					부터
					&nbsp;&nbsp;
					<button type="button" id="btn_left2" class="btn_lbs_arr">
						<img src="../images/arr_b.png" alt="◀">
					</button>
					<input type="text" name="edate" value="<?=$edate?>" id="edate" class="f333_12" size="12" readonly>
					<button type="button" id="btn_right2" class="btn_lbs_arr">
						<img src="../images/arr_f.png" alt="▶">
					</button>
					&nbsp;&nbsp;
					<img src="../images/icon_cal_r.png" alt="달력보기" id="btn_img2">
					&nbsp;
					<select id="etime" name="etime">
						<? 
						for($i=0; $i <= 23; $i++){ 
						?>
							<option value="<?=$i?>" <?if($i == $etime){echo "selected";}?>><?=$i?></option>
						<? 
						}
						?>	
					</select> &nbsp;시
			...
			<li class="li100_nor_rignt">
				<table id="list_table" class="tb_data pB0 lbdg">
					<thead class="tb_data_tbg">
						<tr>
							<th class="li50">구분</th>
							<th class="li50 bL_1gry">자료 데이터</th>
						</tr>
					</thead>
			        <tbody>
						<?
...
$(document).ready(function(){
	...
	// mode 값 변경
	if(mode == '0'){ mode = 'rain'; }
	else if(mode == '1'){ mode = 'flow'; }
	else if(mode == '2'){ mode = 'snow'; }
	...
	function graph_on(){
		...
		$.ajax({
			...
			data: { "mode" : mode+"_10m", "area_code" : $("#area_code").val(), "type" : "S", "sdate" : "<?=$sdate?>", 
					"edate" : "<?=$edate?>", "stime" : $("#stime").val(), "etime" : $("#etime").val() },
	        cache: false,
	        dataType: "json",
