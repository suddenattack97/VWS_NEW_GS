...
require_once "../_info/_dtm_snow.php";
...
<div id="right">
	...
	<div class="tit"><img src="../images/board_icon_aws.png"> <span>적설자료</span></div>
			<!-- <img src="../images/title_04_01.png" alt="강우 자료"> -->
		</div>

		<div class="right_bg2">
		<ul id="search_box">
		<form id="form_search" action="dtm_snow.php" method="post">
			<li>
...
$(document).ready(function(){
	...
	$("#view_table #data").click(function(){
		...
		$.ajax({
		    ...
		    data: { "mode" : "snow", "area_code" : area_code, "sdate" : "<?=$sdate?>", "hour" : hour, "OTT" : "<?=$ott?>" },
	        cache: false,
	        dataType: "json",
