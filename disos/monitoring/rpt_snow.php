...
require_once "../_info/_rpt_snow.php";
...
<div id="right">
	...
	<div id="content">
		...
		<div class="guide_txt"> <ul><li class="icon"><i class="fa fa-paperclip"></i></li><li class="txt02">단위 [cm]</li></ul></div>
				</div>
			...
			<li class="btn_area">
				<span id="button" class="tit">
					...
					<button type="button" id="btn_search" class="btn_bb80">검색</button>
					 ...
					 <!-- <button type="button" id="btn_step" class="btn_bb80 mL_10"><i class="fa fa-search mR_5 font15"></i>검색</button>
					 <button type="button" id="btn_step" class="btn_bb80"><i class="fa fa-print mR_5 font15"></i>인쇄</button>
					 <button type="button" id="btn_step" class="btn_bb80"><i class="fa fa-file-excel-o mR_5 font15"></i>엑셀</button> -->
				</span>
			</li>
		</ul>
		<ul class="stitle_box">
...
$(document).ready(function(){
	localStorage.setItem("layout","rpt_snow.php");
	...
	function graph_on(){
    	...
    	if($('input[name="sel_date"]:checked').val() == "A"){
			$.ajax({
				...
				data: { "mode" : "snow_10m", "area_code" : $("#area_code").val(), "type" : "D", "sdate" : "<?=$sdate?>", "edate" : "<?=$edate?>" },
				cache: false,
				dataType: "json",
			...
			$.ajax({
				type: "POST",
				url: "../_info/json/_rpt_json.php",
				data: { "mode" : "snow", "area_code" : $("#area_code").val(), "type" : "<?=$type?>", "sdate" : "<?=$sdate?>" },
				cache: false,
				dataType: "json",
				success : function(data){
					//console.log(data);
