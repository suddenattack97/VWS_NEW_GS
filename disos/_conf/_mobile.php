...
if($_REQUEST['menu'] == "rtulocation"){ // 위치정보 xml
	header("Location: ./disos/mobile/rtu/rtulocation.php?menu=".$_REQUEST['menu']."&mynumber=".$_REQUEST['mynumber']); exit;
}
...
if(MobileCheck() == "Mobile"){
	...
	if( empty($_REQUEST['mynumber']) ){
		...
		$url = "./disos/mobile/index.php?menu=".$_REQUEST['menu']."&mynumber=".$_REQUEST['mynumber']."&device_id=".$_REQUEST['device_id'];
